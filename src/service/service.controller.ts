...
export class ServiceController {
    ...
    @Post()
    async create(@Body() createServiceDto: Service, @Request() req): Promise<Service> {
    ...
    @UseGuards(JwtAuthGuard)
    @Patch(':id')
    async update(@Param('id') id: number, @Body() updateServiceDto: Partial<Service>, @Request() req): Promise<Service> {
